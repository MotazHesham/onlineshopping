<?php
    ...
    */
	 ...
	 */
	 ...
	 /* Select Records Function -> version 1.0
	 */
	 function getrecords($select,$from,$where,$orderby,$order){

	 	global $con;

	 	$statment = $con -> prepare("SELECT $select FROM $from $where ORDER BY $orderby $order");
	 ...
	 /* Select one Record Function -> version 1.0
	 */
